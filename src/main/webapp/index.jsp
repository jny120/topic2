	...
	<div class="main-content-wrapper d-flex clearfix">
		...
		<div class="mobile-nav">
			...
			<div class="amado-navbar-brand">
				<a href="<c:url value='/index.jsp' />"><img src="img/core-img/logo.png" alt=""></a>
			</div>
			<!-- Navbar Toggler -->
		...
		<header class="header-area clearfix">
			...
			<div class="cart-fav-search mb-100">
				<a href="<c:url value='/showMemberInfo/showMemberInfo.do' />"
					class="cart-nav"><img src="img/core-img/cart.png" alt="">
					Account <span>(0)</span></a> <a href="#" class="fav-nav"><img
					src="img/core-img/favorites.png" alt=""> Favorite</a> <a href="#"
