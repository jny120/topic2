    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="cart-fav-search mb-100">
                <a href="cart.html" class="cart-nav"><img src="../../amado-master/img/core-img/cart.png" alt=""> Cart
                    <span>(0)</span></a>
                            ...
                            <form action="<c:url value='/login.do' />" method="post" name="loginForm"
                                ...
                                <div class="col-18 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="memberId" id="UserId" placeholder="UserId"
                                        value="${cookie['user'].getValue()}">&nbsp;${ErrorMsgKey.AccountEmptyError}
                                </div>
                                <div class="col-18 mb-3">
                                    <label for="Password">Password: </label>
                                    <input type="password" class="form-control" name="password" id="Password" placeholder="Password"
                                        value="${cookie['password'].getValue()}">&nbsp;${ErrorMsgKey.PasswordEmptyError}
                                </div>
                                <div class="col-12">
                                ...
                                <div class="cart-btn mt-100">
                                    ...
                                    <a href="<c:url value='/member/regist/regist.jsp' />"><p style="text-align: center; margin: 5px; color: #4F9D9D ">or Sign up</p></a>
